...
pip3 install --upgrade PyAudio wikipedia PyUserInput tinydb youtube_dl spacy pyowm tensorflow==1.0.0 deepspeech==0.2.0a5 tweepy metadata_parser hug hug-middleware-cors waitress PyMySQL && python3 -m spacy download en \
