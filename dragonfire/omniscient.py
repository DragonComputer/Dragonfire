...
if __name__ == "__main__":
    ...
    while True:
        ...
        if omniscient.respond("Where is the Times Square") == "New York City": score += 1

        # 2,720 ft - QUANTITY
        print("\nWhat is the height of Burj Khalifa")
        if omniscient.respond("What is the height of Burj Khalifa") == "(2,717 feet": score += 1

        # Dubai
        print("\nWhere is Burj Khalifa")
        if omniscient.respond("Where is Burj Khalifa") == "Dubai": score += 1

        # 481 feet - QUANTITY
        print("\nWhat is the height of Great Pyramid of Giza")
        if omniscient.respond("What is the height of Great Pyramid of Giza") == "(481 feet": score += 1

        # Kit Harington
        print("\nWho is playing Jon Snow in Game of Thrones")
        if omniscient.respond("Who is playing Jon Snow in Game of Thrones") == "Kit Harington": score += 1

        # 8 - CARDINAL
        print("\nWhat is the atomic number of oxygen")
        if omniscient.respond("What is the atomic number of oxygen") == "8": score += 1

        # 1.371 billion - QUANTITY
        # print "\nWhat is the population of China"
        # if omniscient.respond("What is the population of China") == "1.371 billion": score += 1

        # Japanese - LANGUAGE
        print("\nWhat is the official language of Japan")
        if omniscient.respond("What is the official language of Japan") == "Japanese": score += 1

        # Stark - PERSON
        print("\nWhat is the real name of Iron Man")
        if omniscient.respond("What is the real name of Iron Man") in ["Stark", "Tony Stark"]: score += 1

        # Mehmed The Conqueror - PERSON
        print("\nWho is the conqueror of Constantinople")
        if omniscient.respond("Who is the conqueror of Constantinople") in ["Mehmed II", "Mehmet II", "Mehmet"]: score += 1

        # 1453 - DATE TIME
        print("\nWhen Constantinople was conquered")
        if omniscient.respond("When Constantinople was conquered") == "1453": score += 1

        # Ankara - GPE
        print("\nWhat is the capital of Turkey")
        if omniscient.respond("What is the capital of Turkey") == "Ankara": score += 1

        # Istanbul - GPE
        print("\nWhat is the largest city of Turkey")
        if omniscient.respond("What is the largest city of Turkey") == "Istanbul": score += 1

        # Hinduism - NORP
        # print "\nWhat is the name of the oldest religion"
        # if omniscient.respond("What is the name of the oldest religion") == "Hinduism": score += 1

        # Hartsfield Jackson Atlanta International Airport - FACILITY
        # print "\nWhat is the name of the world's busiest airport"
        # if (omniscient.respond("What is the name of the world's busiest airport") == "Hartsfield Jackson Atlanta International Airport"): score += 1

        # Harvard University - ORG
        print("\nWhat is the name of the world's best university")
        if omniscient.respond("What is the name of the world's best university") in ["Harvard", "Peking University"]: score += 1

        # Nile river - LOC
        print("\nWhat is the name of the world's longest river")
        if omniscient.respond("What is the name of the world's longest river") in ["Nile", "Amazon"]: score += 1

        # Rolls-Royce - PRODUCT
        print("\nWhat is the brand of the world's most expensive car")
        if omniscient.respond("What is the brand of the world's most expensive car") == "Rolls-Royce": score += 1

        # World War II - EVENT
        print("\nWhat is the bloodiest war in human history")
        if omniscient.respond("What is the bloodiest war in human history") in ["World War II", "World War I"]: score += 1

        # Da Vinci Code - WORK_OF_ART
        print("\nWhat is the name of the best seller book")
        if omniscient.respond("What is the name of the best seller book") in ["Real Marriage", "'Real Marriage' on"]: score += 1

        # the Mariana Trench - LOC
        print("\nWhat is the lowest point in the ocean")
        if omniscient.respond("What is the lowest point in the ocean") == "the Mariana Trench": score += 1

        # Einstein - PERSON
        print("\nWho invented General Relativity")
        if omniscient.respond("Who invented General Relativity") == "Einstein": score += 1

        # 1945 - DATE TIME
        print("\nWhen was United Nations formed")
        if omniscient.respond("When was United Nations formed") == "1945": score += 1
