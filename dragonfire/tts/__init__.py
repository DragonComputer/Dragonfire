...
class Synthesizer():
    ...
    def run(self, string):
        ...
        wf = wave.open(repr(time.time()).replace('.','_') + ".wav", 'wb') # Create the .wav file with a random name
...
if __name__ == "__main__":
    syn = Synthesizer()
    syn.run("I have a female voice but I don't have a gender identity. I'm a computer program, sir.")
