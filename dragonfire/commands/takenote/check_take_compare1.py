...
.. module:: check_take_compare1
    :platform: Unix
    :synopsis: the top-level submodule of Dragonfire.commands.takenote that contains the function related to Dragonfire's simple if-else struct of taking note ability.
